...
namespace MB_Project.Migrations
{
    ...
    public partial class NewDataBase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "OrderPostFeature",
                columns: table => new
                {
                    OrdersId = table.Column<int>(type: "int", nullable: false),
                    PostFeaturesId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderPostFeature", x => new { x.OrdersId, x.PostFeaturesId });
                    table.ForeignKey(
                        name: "FK_OrderPostFeature_Orders_OrdersId",
                        column: x => x.OrdersId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderPostFeature_PostFeatures_PostFeaturesId",
                        column: x => x.PostFeaturesId,
                        principalTable: "PostFeatures",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { "9b3e174e-10e6-446f-86af-483d56fd7210", null, "SELLER", "SELLER" },
                    { "ae2626ab-cea5-458f-82f5-2dbad5009e29", null, "ADMIN", "ADMIN" }
                });

            migrationBuilder.CreateIndex(
                name: "IX_OrderPostFeature_PostFeaturesId",
                table: "OrderPostFeature",
